...
const routes: Routes = [
  ...
  { path: 'update/:id', loadChildren: () => import('./views/update/update.module').then(mod => mod.UpdateModule), canActivate: [AuthGuard] },
  ...
  { path: 'add', loadChildren: () => import('./views/add/add.module').then(mod =>  mod.AddModule), canActivate: [AuthGuard] }
